      ...
      <section className="py-20 bg-[#007BA7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            منصة رائدة في توجيه الشباب  السعودي  نحو مستقبل مهني مشرق 
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    أن نكون المنصة الأولى في العالم  السعودي لتمكين الشباب من اكتشاف مساراتهم المهنية 
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    نساعد الشباب   السعودي  على اتخاذ قرارات مهنية مستنيرة من خلال توفير اختبارات علمية دقيقة، 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                بدأت فكرة مسار المستقبل من حاجة ملحة لمساعدة الشباب   السعودي   في التعامل مع التحديات المعقدة 
